...
import com.jx.AIPlatform.core.handler.StreamHandlerExecutor;
...
import com.jx.AIPlatform.service.ChatHistoryService;
import com.jx.AIPlatform.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        // 1.参数校验
        ThrowUtils.throwIf(appId == null || appId <= 0, ErrorCode.PARAMS_ERROR, "用户ID错误");
